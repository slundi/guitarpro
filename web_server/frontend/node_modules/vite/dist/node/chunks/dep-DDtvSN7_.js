...
(function (exports) {
	...
	function handleDeprecatedConstructorOpts(opts) {
	...
	var Attribute = /*#__PURE__*/function (_Namespace) {
	  ...
	  function Attribute(opts) {
	    ...
	    _this = _Namespace.call(this, handleDeprecatedConstructorOpts(opts)) || this;
...
function localizeDeclaration(declaration, context) {
  ...
  if (isAnimation) {
    ...
    const valueNodes = valueParser(declaration.value).walk((node) => {
      // If div-token appeared (represents as comma ','), a possibility of an animation-keywords should be refresh.
      if (node.type === "div") {
